...
@Component({
  selector: 'app-card-filosopher',
  templateUrl: './card-filosopher.component.html',
  styleUrls: ['./card-filosopher.component.css']
})
export class CardFilosopherComponent implements OnInit {
